...
function getFileContentAsBase64(path,callback){
  ...
  targetHeight: 347,
    ...
    function capturePhotoEditnoticia() {
      // Take picture using device camera, allow edit, and retrieve image as base64-encoded string
      navigator.camera.getPicture(onPhotoDataSuccessnoticia, onFail, { quality: 20, allowEdit: true,
        destinationType: destinationType.DATA_URL,
          targetWidth: 347,
  targetHeight: 347,
    saveToPhotoAlbum:true
    ...
    function getPhotonoticia(source) {
      ...
      navigator.camera.getPicture(onPhotoURISuccessnoticia, onFail, { quality: 20, 
