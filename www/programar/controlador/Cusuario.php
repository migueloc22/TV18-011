...
if(isset($_POST['action'])) {
    $action = $_POST['action'];
    switch($action) {
        case 'sessionavatar' : sessionavatar();break;
           case 'sessionUsuario' : sessionUsuario();break;
        case 'sessionHijo' : sessionHijo();break;
             case 'CrearsessionHijo' : CrearsessionHijo();break;
        case 'actividad' : actividad();break;
                case 'CrearDtosResult' : CrearDtosResult();break;
                     case 'ConsultaAvatart' : ConsultaAvatart();break;
             case 'Consultaimctmb' : Consultaimctmb();break;
               case 'Consulgrafica' : Consulgrafica();break;
               case 'chatusuarios' : chatusuarios();break;
               case 'sessionchat': sessionchat();break;
  case 'usuariolocal': usuariolocal();break;
    case 'noticias': noticias();break;
        case 'listahijos': listahijos();break;
        case 'fotoperfil': fotoperfil();break;
        case 'updateregistro': updateregistro();break;
